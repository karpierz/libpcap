...
----------------------
- Upgrade to the latest libpcap API 1.11.0-PRE
- | Upgrade and addition of shared libraries for multiple platforms
  | (mostly from conda-forge, some from Debian package repository to
  | the version 1.10.6).
...
---------------------
- Upgrade to the latest libpcap API 1.11.0-PRE
- Added support for macOS x64 (thank you very much Erik Rainey emrainey@Github
...
- Added support for libpcap from `Npcap <https://nmap.org/npcap/>`__.
